    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-5xl">Personaliza Tu Producto</h2>

                <p class="mx-auto mt-4 max-w-xl text-gray-500">
                    Estamos especializados en adaptar nuestras soluciones a tus necesidades específicas. La sección
                    "Personaliza Tu Experiencia" está diseñada para ofrecerte un nivel único de flexibilidad y adaptabilidad
                    en nuestras soluciones tecnológicas. Descubre cómo puedes dar forma a tu experiencia con nosotros y
                    obtener herramientas que se ajusten perfectamente a tu visión y objetivos.
                </p>
